/**
 * Projet Dorfomantik
 * Chemin du fichier : dorfromantik/src/view/MoveUpAction.java
 * Fait par : Marwa Hafsati, Djedjiga Yahiaoui, et Raphael Beau
 *
 * Cette classe représente une action permettant de déplacer la vue du plateau vers le haut.
...
/**
 * Action pour déplacer virtuellement le plateau vers le haut.
...
public class MoveUpAction extends AbstractAction {
     ...
     */
    public MoveUpAction(BoardPanel boardPanel) {
        this.boardPanel = boardPanel;
    }

    /**
     * Méthode appelée lorsque l'action est déclenchée.
     * Déplace le centre virtuel du plateau vers le haut.
     *
