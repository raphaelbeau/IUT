/**
 * Projet Dorfomantik
 * Chemin du fichier : dorfromantik/src/view/MoveRightAction.java
 * Fait par : Marwa Hafsati, Djedjiga Yahiaoui, et Raphael Beau
 *
 * Cette classe représente une action permettant de déplacer la vue du plateau vers la droite.
...
/**
 * Action pour déplacer virtuellement le plateau vers la droite.
...
public class MoveRightAction extends AbstractAction {
     ...
     */
    public MoveRightAction(BoardPanel boardPanel) {
        this.boardPanel = boardPanel;
    }

    /**
     * Méthode appelée lorsque l'action est déclenchée.
     * Déplace le centre virtuel du plateau vers la droite.
     *
